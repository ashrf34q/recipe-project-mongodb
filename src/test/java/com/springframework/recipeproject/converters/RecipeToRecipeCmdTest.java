...
public class RecipeToRecipeCmdTest {
    ...
    RecipeToRecipeCmd converter;

    @BeforeEach
    public void setUp() throws Exception {
        converter = new RecipeToRecipeCmd(
                new CategoryToCategoryCmd(),
                new IngredientToIngredientCmd(new UoMToUoMCmd()),
                new NotesToNotesCmd());
    }
